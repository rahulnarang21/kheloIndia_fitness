...
public class AttendanceSchoolActivity extends AppCompatActivity implements ItemClickListener {
    ...
    private void init() {
        ...
        Utility.showActionBar(this, toolbar, getString(R.string.school_select));
    ...
    public void onItemClick(View view, int position) {
        ...
        if(latitude.length()>0 && longitude.length()>0){
            Intent i = new Intent(AttendanceSchoolActivity.this, AttendanceGeofencingActivity.class);
        ...
        /*if (school_id.equals(sp.getString("tracking_school_id", "0"))) {
            ...
            Toast.makeText(getApplicationContext(),"No Location Found For This School.", Toast.LENGTH_LONG).show();
        }
