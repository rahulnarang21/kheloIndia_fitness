...
/**
 * Created by PC10 on 31-May-18.
 */

public class SendLocationAfterFixedIntervalReceiver extends BroadcastReceiver implements ResponseListener {
    ...
    DBManager db;
    String TAG = "SendLocationAfterFixedIntervalReceiver";
    @Override
    public void onReceive(Context context, Intent intent) {
        ...
        Log.e(TAG,"*********************** on receive SendLocationAfterFixedIntervalReceiver***********");
